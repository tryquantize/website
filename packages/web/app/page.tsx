...
/* File Overview
  Path: app/page.tsx
  Purpose: Main landing page for the Quantize AI Discovery Platform

  Reading tip for newcomers:
  - This is a client component that uses React hooks
  - Wrapped with PageLayout for consistent header/footer
*/
