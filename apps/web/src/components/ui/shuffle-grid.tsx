    ...
    <section className="w-full px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-base md:text-lg text-muted-foreground my-4 md:my-6">
          Quantize transforms how you discover information. Our advanced AI understands context, 
          delivers precise answers, and connects you with the knowledge you need instantly.
        </p>
        <button className={cn(
