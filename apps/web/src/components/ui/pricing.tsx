      ...
      <div className="flex justify-center items-center mb-10 gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 sm:2 gap-4 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            className={cn(
              `rounded-2xl border-[1px] p-6 bg-black/20 backdrop-blur-md text-center lg:flex lg:flex-col lg:justify-center relative`,
              plan.isPopular ? "border-primary border-2" : "border-white/20",
              "flex flex-col",
              !plan.isPopular && "mt-5",
              index === 0 || index === 2
              ...
              <ul className="mt-5 gap-2 flex flex-col">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    ...
                    <span className="text-left text-white/90">{feature}</span>
                  </li>
                ))}
              </ul>
