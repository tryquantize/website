...
const steps: readonly Step[] = [
  {
    ...
    description: "Experience intelligent search that understands context and delivers precise answers from across the web.",
  },
  {
    id: "2",
    name: "Step 2",
    title: "Real-time Results",
    description: "Get instant, comprehensive results with proper citations and source attribution for every query.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "Smart Suggestions",
    description: "Discover related topics and follow-up questions to deepen your research and understanding.",
  },
  {
    id: "4",
    name: "Step 4",
    title: "Seamless Experience",
    description: "Enjoy a clean, fast interface designed for researchers, students, and professionals.",
  },
]
